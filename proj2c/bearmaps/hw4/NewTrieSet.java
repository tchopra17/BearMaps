...
/**
 *  The {@code NewTrieSet} class represents an ordered set of strings over
...
public class NewTrieSet implements Iterable<String> {
    private static final int R =123;        // extended ASCII
    ...
    /**
     * Unit tests the {@code NewTrieSet} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        NewTrieSet set = new NewTrieSet();
        while (!StdIn.isEmpty()) {
